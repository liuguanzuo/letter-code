...
class Letter extends Component{
    ...
    render(){
        ...
        return(
            <div className="App animated bounceInLeft" style={{height:'100%'}}>
            ...
            <div id="autotype2">
                <p>到今天我们已经认识好久好久了，从2018年10月28日到现在，我们一起经历了好多好多的事情，
                    有欢笑也有争吵，也曾因为一些事情闹过不愉快，但是都走过来了。</p>
                <p>给你看看我珍藏到现在的表情吧！</p> <img className={'picin'} src={pic} width="20%" height="20%" onError="imgerror(this)"></img>
                ...
                <p>...</p>
                <p>...</p>
                <p>我不善于文字表达，写了这一个网页，又说那么多话。其实也就想和你说一句:"认识你真好!",仅此。</p>
